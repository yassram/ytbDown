...
//  ======================================================================================================
//  ||                                                                                                  ||
//  ||                          https://github.com/yassram/YoutubeVideoExtractor                        ||
//  ||                                                                                                  ||
//  ======================================================================================================
...
struct YoutubeVideoUrlExtractor {
    fileprivate static func getDictionnaryFrom(string: String) -> [String: String] {
    ...
    static func extractVideos(from youtubeId: String, completion: @escaping (([String: String]) -> Void)) {
